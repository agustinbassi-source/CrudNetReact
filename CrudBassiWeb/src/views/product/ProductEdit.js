...
import { validateProduct } from '../../services/ValidationProductService'
const ProductEdit = () => {
...
const renderErrors = () =>
  ...
  const saveChanges = (e) => {
    ...
    errorsArray.push(...validateProduct(model));
    ...
    const response = fetch(process.env.REACT_APP_API_URL + `api/Products/${id}`, {
